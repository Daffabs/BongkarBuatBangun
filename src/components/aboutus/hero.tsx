...
export default function HeroAboutUs() {
  return (
    <section
      className="grid grid-cols-1 md:grid-cols-[auto,1fr] gap-8 md:gap-12 items-start 
                        py-12 sm:py-20 md:py-24 lg:py-28 
                        px-4 sm:px-8 md:px-16 lg:px-24"
    >
      {/* Kiri */}
      <div className="mb-4 md:mb-0">
        <span className="text-white text-sm sm:text-base md:text-lg lg:text-xl">+ Tentang Kami</span>
      </div>

      {/* Kanan */}
      <div>
        <h1
          className="text-4xl sm:text-4xl md:text-5xl lg:text-7xl
